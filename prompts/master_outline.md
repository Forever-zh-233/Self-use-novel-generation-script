...
```json
{
  ...
  "world_geography": {
    "overview": "全书地理大势一句话(如：故事发生在大梁国南境,主角从北向南漂泊)",
    "regions": [
      {"name": "北砚县辖区", "bearing": "大梁南境最北", "note": "起点,第一卷主场"},
      {"name": "青石镇一带", "bearing": "北砚以南40里", "note": "第一卷中段"}
    ],
    "mc_route": "主角整体移动路线(如：北砚→青石→雾南泽,一路向南)"
  },
  "volumes": [
    {
      "volume": 1,
...
11. **world_geography 只画大尺度方位骨架**——区域级的相对位置和主角移动路线,不写城镇内部布局(那是下游卷纲/弧线/章节的尺度)。这是防"跨地点路线错"的北极星:下游所有地点都挂在这个方位骨架下,不能让主角往南走却到了北边的地方。
